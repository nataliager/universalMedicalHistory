...
.HomeImagen1 {
    position: relative;
    top: -350px; /* ajustar los valores para mover la imagen */
    left: -5px;
    border-radius: 50%;
    margin: 30%;
